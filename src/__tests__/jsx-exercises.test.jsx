...
describe("JSX Practice exercises", () => {
  ...
  `;
    ...
    test("profile image 1", () => {
      ...
      const ProfileImage = () => <img src="https://placekitten.com/200/300" className="photo"/>;
    ...
    test("customer card", () => {
      ...
      const CustomerCard = () => <section data-testid="blueberry"><h1>BlueBerry INC</h1></section>;
    ...
    test("profile image 2", () => {
      ...
      const ProfileImage = () => <img src="https://placekitten.com/200/300" style={{borderColor: "red"}}/>;
